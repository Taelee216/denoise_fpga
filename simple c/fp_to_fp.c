...
static const float input_dense_weights[1008] = {
	-10, 0, -3, 1, -8, -6, 3, -13,
	1, 0, -3, -7, -5, -3, 6, -1,
	-6, 0, -6, -4, -1, -2, 1, 1,
...
static const float input_dense_bias[24] = {
...
static const float vad_gru_weights[1728] = {
...
static const float vad_gru_recurrent_weights[1728] = {
...
static const float vad_gru_bias[72] = {
...
static const float noise_gru_weights[12960] = {
	-10, -8, 5, -72, 7, 55, -38, 3,
...
static const float noise_gru_recurrent_weights[6912] = {
...
static const float noise_gru_bias[144] = {
...
static const float denoise_gru_weights[32832] = {
...
static const float denoise_gru_recurrent_weights[27648] = {
...
static const float denoise_gru_bias[288] = {
...
static const float denoise_output_weights[2112] = {
...
static const float denoise_output_bias[22] = {
...
float gain[22] = {
	0.129255,  0.221202,  0.195956, 0.207909,  0.180190,  0.252392,  0.248490,  0.214852,  0.199886, 0.212310 , 0.195907 , 0.193804,  0.222044,  0.251122,  0.211202 , 0.184392 , 0.160439 , 0.151432 , 0.152264 , 0.183748 , 0.250726 , 0.358647
};
...
///////////////////////////////////////////////////////////////////////////     vad_gru_recurrent_weights
	f_out	= fopen("vad_gru_recurrent_weights_fixed.mem", "w");
	...
	for (int i = 0; i < size; i++) {
		...
		out_fixed(double_to_fixed(vad_gru_recurrent_weights[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);
...
/////////////////////////////////////////////////////////////////////////// noise_gru_recurrent_weights
	f_out = fopen("noise_gru_recurrent_weights_fixed.mem", "w");
	...
	for (int i = 0; i < size; i++) {
		...
		out_fixed(double_to_fixed(noise_gru_recurrent_weights[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);
...
/////////////////////////////////////////////////////////////////////////// denoise_gru_weights
	f_out = fopen("denoise_gru_input_weights_fixed.mem", "w");
	...
	for (int i = 0; i < size; i++) {
		...
		out_fixed(double_to_fixed(denoise_gru_weights[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);
...
/////////////////////////////////////////////////////////////////////////// denoise_gru_recurrent_weights
	f_out = fopen("denoise_gru_recurrent_weights_fixed.mem", "w");
	...
	for (int i = 0; i < size; i++) {
		...
		out_fixed(double_to_fixed(denoise_gru_recurrent_weights[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);
...
/////////////////////////////////////////////////////////////////////////// denoise_output_weights
	f_out = fopen("denoise_output_weights_fixed.mem", "w");
	...
	for (int i = 0; i < size; i++) {
		...
		out_fixed(double_to_fixed(denoise_output_weights[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);
...
/////////////////////////////////////////////////////////////////////////// vad_output_weights
	...
	for (int i = 0; i < size; i++) {
		...
		out_fixed(double_to_fixed(vad_output_weights[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);

	f_out	= fopen("feature_fixed.mem", "w");
	size    = sizeof(feature) / sizeof(feature[0]);
	for (int i = 0; i < size; i++) {
		// fprintf(f_out, "assign\tinput_dense_bias_array[%5d] = 32'b", i);
		out_fixed(double_to_fixed(feature[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);

	f_out	= fopen("gain_fixed.mem", "w");
	size    = sizeof(gain) / sizeof(gain[0]);
	for (int i = 0; i < size; i++) {
		// fprintf(f_out, "assign\tinput_dense_bias_array[%5d] = 32'b", i);
		out_fixed(double_to_fixed(gain[i]));
		fprintf(f_out, "\n");
		// fprintf(f_out, ";\n");
	}
	fclose(f_out);
